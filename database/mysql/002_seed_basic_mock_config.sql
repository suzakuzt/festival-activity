...
-- Begin latest exam sign library override
INSERT INTO draw_result_config (
  activity_code, result_code, result_level, result_title, main_text, good_text, avoid_text,
  explain_title, explain_content, tags_json, product_code, reward_code, status, sort_order, ext_json
)
VALUES
  (
    ...
    'enabled',
    10,
    '{"sign_type":"过儿签","fortune_headline":"过儿签","fortune_hint":"考试期间，\n别叫我真名，\n叫我过儿，\n最好叫我全过儿。","main_text_columns":["考试期间，","别叫我真名，","叫我过儿，","最好叫我全过儿。"],"explain_text":"此签属“礼貌玄学派”。名字可以临时改，准考证名字不能乱写。建议考前默念三遍：我会的全对，不会的也别太离谱。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_002',
    ...
    '',
    'AI解签结果',
    '此签寓意“先苦后甜”。现在少喝一口奶茶，考完多点两杯。你的努力不是没味道，只是还没到加糖的时候。',
    '["奶茶签","高考好运","考前放轻松"]',
    'sku_002',
    'coupon_10',
    'enabled',
    20,
    '{"sign_type":"奶茶签","fortune_headline":"奶茶签","fortune_hint":"今日多写一题，\n明日多加一份料。\n珍珠会沉底，\n分数会浮上来。","main_text_columns":["今日多写一题，","明日多加一份料。","珍珠会沉底，","分数会浮上来。"],"explain_text":"此签寓意“先苦后甜”。现在少喝一口奶茶，考完多点两杯。你的努力不是没味道，只是还没到加糖的时候。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_003',
    ...
    '',
    'AI解签结果',
    '此签主打现实保佑。高考当天别挑战新食物，肠胃不是隐藏科目。吃熟悉的饭，考熟悉的分。',
    '["早饭签","高考好运","考前放轻松"]',
    'sku_003',
    'coupon_10',
    'enabled',
    30,
    '{"sign_type":"早饭签","fortune_headline":"早饭签","fortune_hint":"早餐吃稳，\n心态放平。\n肚子不闹，\n脑子开机。","main_text_columns":["早餐吃稳，","心态放平。","肚子不闹，","脑子开机。"],"explain_text":"此签主打现实保佑。高考当天别挑战新食物，肠胃不是隐藏科目。吃熟悉的饭，考熟悉的分。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_004',
    ...
    '',
    'AI解签结果',
    '此签适合心态紧张的人。高考不是唯一一辆车，但这班车既然来了，就好好坐稳。别看窗外别人多快，先把自己的路线走顺。',
    '["公交签","高考好运","考前放轻松"]',
    'sku_004',
    'coupon_10',
    'enabled',
    40,
    '{"sign_type":"公交签","fortune_headline":"公交签","fortune_hint":"人生像公交，\n错过一站别慌。\n下一站，\n也可能到大学。","main_text_columns":["人生像公交，","错过一站别慌。","下一站，","也可能到大学。"],"explain_text":"此签适合心态紧张的人。高考不是唯一一辆车，但这班车既然来了，就好好坐稳。别看窗外别人多快，先把自己的路线走顺。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_005',
    ...
    '',
    'AI解签结果',
    '此签属“好运派送中”。请保持手机静音，保持脑子在线。好运可以送到门口，但卷子还得你自己签收。',
    '["外卖签","高考好运","考前放轻松"]',
    'sku_001',
    'coupon_10',
    'enabled',
    50,
    '{"sign_type":"外卖签","fortune_headline":"外卖签","fortune_hint":"考神已接单，\n好运在配送。\n预计送达：\n开考后三分钟。","main_text_columns":["考神已接单，","好运在配送。","预计送达：","开考后三分钟。"],"explain_text":"此签属“好运派送中”。请保持手机静音，保持脑子在线。好运可以送到门口，但卷子还得你自己签收。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_006',
    ...
    '',
    'AI解签结果',
    '此签专治考前硬熬。你不是永动机，知识点也怕低电量模式。睡好一点，发挥才有高清画质。',
    '["充电签","高考好运","考前放轻松"]',
    'sku_002',
    'coupon_10',
    'enabled',
    60,
    '{"sign_type":"充电签","fortune_headline":"充电签","fortune_hint":"脑子像手机，\n熬夜会掉电。\n今晚充满格，\n明天直接亮屏。","main_text_columns":["脑子像手机，","熬夜会掉电。","今晚充满格，","明天直接亮屏。"],"explain_text":"此签专治考前硬熬。你不是永动机，知识点也怕低电量模式。睡好一点，发挥才有高清画质。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_007',
    ...
    '',
    'AI解签结果',
    '此签提醒“先看题，再动笔”。很多失分不是不会，是导航没开就猛踩油门。看清关键词，比多写两行更值钱。',
    '["导航签","高考好运","考前放轻松"]',
    'sku_003',
    'coupon_10',
    'enabled',
    70,
    '{"sign_type":"导航签","fortune_headline":"导航签","fortune_hint":"题目像地图，\n审题是导航。\n路线看清楚，\n别开进沟里。","main_text_columns":["题目像地图，","审题是导航。","路线看清楚，","别开进沟里。"],"explain_text":"此签提醒“先看题，再动笔”。很多失分不是不会，是导航没开就猛踩油门。看清关键词，比多写两行更值钱。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_008',
    ...
    '',
    'AI解签结果',
    '此签寓意稳步上升。临场别急，先拿基础分，再冲提高分。电梯会到，前提是你别半路乱跳。',
    '["电梯签","高考好运","考前放轻松"]',
    'sku_004',
    'coupon_10',
    'enabled',
    80,
    '{"sign_type":"电梯签","fortune_headline":"电梯签","fortune_hint":"分数像电梯，\n一步一步升。\n别猛按按钮，\n它也需要运行。","main_text_columns":["分数像电梯，","一步一步升。","别猛按按钮，","它也需要运行。"],"explain_text":"此签寓意稳步上升。临场别急，先拿基础分，再冲提高分。电梯会到，前提是你别半路乱跳。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_009',
    ...
    '',
    'AI解签结果',
    '此签属于“错题报恩签”。你曾经红笔改过的地方，今天可能正好救你一命。错题本不是黑历史，是洗干净的战袍。',
    '["洗衣签","高考好运","考前放轻松"]',
    'sku_001',
    'coupon_10',
    'enabled',
    90,
    '{"sign_type":"洗衣签","fortune_headline":"洗衣签","fortune_hint":"错题像脏衣，\n洗过才干净。\n以前错得多，\n今天错得少。","main_text_columns":["错题像脏衣，","洗过才干净。","以前错得多，","今天错得少。"],"explain_text":"此签属于“错题报恩签”。你曾经红笔改过的地方，今天可能正好救你一命。错题本不是黑历史，是洗干净的战袍。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_010',
    ...
    '',
    'AI解签结果',
    '此签提醒日常积累。临考前别幻想冰箱自动长菜，能拿出来的，都是你之前放进去的。好消息是：你已经囤了不少。',
    '["冰箱签","高考好运","考前放轻松"]',
    'sku_002',
    'coupon_10',
    'enabled',
    100,
    '{"sign_type":"冰箱签","fortune_headline":"冰箱签","fortune_hint":"知识像冰箱，\n平时要囤货。\n考试一打开，\n别全是空盒。","main_text_columns":["知识像冰箱，","平时要囤货。","考试一打开，","别全是空盒。"],"explain_text":"此签提醒日常积累。临考前别幻想冰箱自动长菜，能拿出来的，都是你之前放进去的。好消息是：你已经囤了不少。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_011',
    ...
    '',
    'AI解签结果',
    '此签适合考试节奏。别一开局就猛攻最难题，容易糊锅。先把能吃的分捞起来，再研究那口大锅。',
    '["煮面签","高考好运","考前放轻松"]',
    'sku_003',
    'coupon_10',
    'enabled',
    110,
    '{"sign_type":"煮面签","fortune_headline":"煮面签","fortune_hint":"做题像煮面，\n火候别太猛。\n先熟基础题，\n再加压轴菜。","main_text_columns":["做题像煮面，","火候别太猛。","先熟基础题，","再加压轴菜。"],"explain_text":"此签适合考试节奏。别一开局就猛攻最难题，容易糊锅。先把能吃的分捞起来，再研究那口大锅。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_012',
    ...
    '',
    'AI解签结果',
    '此签主打抗压。遇到难题别崩，它只是天气，不是结局。撑住心态，雨过之后就是下一道送分题。',
    '["雨伞签","高考好运","考前放轻松"]',
    'sku_004',
    'coupon_10',
    'enabled',
    120,
    '{"sign_type":"雨伞签","fortune_headline":"雨伞签","fortune_hint":"考场会下雨，\n也会出太阳。\n心里有把伞，\n难题淋不湿你。","main_text_columns":["考场会下雨，","也会出太阳。","心里有把伞，","难题淋不湿你。"],"explain_text":"此签主打抗压。遇到难题别崩，它只是天气，不是结局。撑住心态，雨过之后就是下一道送分题。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_013',
    ...
    '',
    'AI解签结果',
    '此签是时间管理符。会做的题就是现货，先装进篮子。压轴题可以逛，但别逛到忘了结账。',
    '["超市签","高考好运","考前放轻松"]',
    'sku_001',
    'coupon_10',
    'enabled',
    130,
    '{"sign_type":"超市签","fortune_headline":"超市签","fortune_hint":"分数像购物，\n能拿就先拿。\n别在难题货架，\n站到商场关门。","main_text_columns":["分数像购物，","能拿就先拿。","别在难题货架，","站到商场关门。"],"explain_text":"此签是时间管理符。会做的题就是现货，先装进篮子。压轴题可以逛，但别逛到忘了结账。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_014',
    ...
    '',
    'AI解签结果',
    '此签适合考前动员。不是所有早起都痛苦，有些早起是去奔赴未来。记得多设两个闹钟，别让梦想睡过头。',
    '["闹钟签","高考好运","考前放轻松"]',
    'sku_002',
    'coupon_10',
    'enabled',
    140,
    '{"sign_type":"闹钟签","fortune_headline":"闹钟签","fortune_hint":"闹钟叫醒人，\n目标叫醒梦。\n别赖在昨天，\n今天要开考。","main_text_columns":["闹钟叫醒人，","目标叫醒梦。","别赖在昨天，","今天要开考。"],"explain_text":"此签适合考前动员。不是所有早起都痛苦，有些早起是去奔赴未来。记得多设两个闹钟，别让梦想睡过头。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_015',
    ...
    '',
    'AI解签结果',
    '此签有一点温柔。你带着刷过的题、背过的书、熬过的夜上路。别怕重，那些都是你去未来的装备。',
    '["行李签","高考好运","考前放轻松"]',
    'sku_003',
    'coupon_10',
    'enabled',
    150,
    '{"sign_type":"行李签","fortune_headline":"行李签","fortune_hint":"高考像行李箱，\n装满三年光。\n拉链一合上，\n出发去远方。","main_text_columns":["高考像行李箱，","装满三年光。","拉链一合上，","出发去远方。"],"explain_text":"此签有一点温柔。你带着刷过的题、背过的书、熬过的夜上路。别怕重，那些都是你去未来的装备。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_016',
    ...
    '',
    'AI解签结果',
    '此签专治紧张。越慌越容易夹生，越稳越容易出味。考场上先深呼吸，再下笔，别让情绪把锅掀翻。',
    '["锅盖签","高考好运","考前放轻松"]',
    'sku_004',
    'coupon_10',
    'enabled',
    160,
    '{"sign_type":"锅盖签","fortune_headline":"锅盖签","fortune_hint":"心态像锅盖，\n别一热就掀。\n稳住小火候，\n答案会慢慢熟。","main_text_columns":["心态像锅盖，","别一热就掀。","稳住小火候，","答案会慢慢熟。"],"explain_text":"此签专治紧张。越慌越容易夹生，越稳越容易出味。考场上先深呼吸，再下笔，别让情绪把锅掀翻。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_017',
    ...
    '',
    'AI解签结果',
    '此签提醒“基础分先拿”。别盯着远处那块压轴肉，手边的青菜也是分。能稳稳夹住的，才是真的进碗里。',
    '["筷子签","高考好运","考前放轻松"]',
    'sku_001',
    'coupon_10',
    'enabled',
    170,
    '{"sign_type":"筷子签","fortune_headline":"筷子签","fortune_hint":"答题像夹菜，\n先夹眼前的。\n够得着的分，\n千万别掉桌上。","main_text_columns":["答题像夹菜，","先夹眼前的。","够得着的分，","千万别掉桌上。"],"explain_text":"此签提醒“基础分先拿”。别盯着远处那块压轴肉，手边的青菜也是分。能稳稳夹住的，才是真的进碗里。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_018',
    ...
    '',
    'AI解签结果',
    '此签适合考场焦虑。别人翻页快，不代表他坐对车；别人皱眉，也不代表你会迷路。跟着自己的节奏，到站再说。',
    '["地铁签","高考好运","考前放轻松"]',
    'sku_002',
    'coupon_10',
    'enabled',
    180,
    '{"sign_type":"地铁签","fortune_headline":"地铁签","fortune_hint":"人潮很吵，\n你有方向。\n到站之前，\n别提前下场。","main_text_columns":["人潮很吵，","你有方向。","到站之前，","别提前下场。"],"explain_text":"此签适合考场焦虑。别人翻页快，不代表他坐对车；别人皱眉，也不代表你会迷路。跟着自己的节奏，到站再说。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_019',
    ...
    '',
    'AI解签结果',
    '此签适合最后冲刺。现在从被窝里爬出来，是为了以后更安心地躺回去。考完以后，床会原谅你这几天的冷落。',
    '["被窝签","高考好运","考前放轻松"]',
    'sku_003',
    'coupon_10',
    'enabled',
    190,
    '{"sign_type":"被窝签","fortune_headline":"被窝签","fortune_hint":"被窝很温柔，\n梦想更催人。\n今天多坚持，\n明天睡到自然醒。","main_text_columns":["被窝很温柔，","梦想更催人。","今天多坚持，","明天睡到自然醒。"],"explain_text":"此签适合最后冲刺。现在从被窝里爬出来，是为了以后更安心地躺回去。考完以后，床会原谅你这几天的冷落。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  ),
  (
    'gaokao_lucky_sign_2026',
    'sign_020',
    ...
    '',
    'AI解签结果',
    '此签为上上签。你不是临时来凑热闹的，你是带着三年库存来结账的。愿你该会的都想起，该得的都拿下。',
    '["金榜签","高考好运","考前放轻松"]',
    'sku_004',
    'coupon_10',
    'enabled',
    200,
    '{"sign_type":"金榜签","fortune_headline":"金榜签","fortune_hint":"笔尖一落，\n少年上桌。\n今日开卷，\n明日上岸。","main_text_columns":["笔尖一落，","少年上桌。","今日开卷，","明日上岸。"],"explain_text":"此签为上上签。你不是临时来凑热闹的，你是带着三年库存来结账的。愿你该会的都想起，该得的都拿下。","theme_text":"高考好运 × 考前放轻松","benefit_id":"default-benefit","claim_button_text":"领取专属福利"}'
  )
ON DUPLICATE KEY UPDATE
  result_level = VALUES(result_level),
  result_title = VALUES(result_title),
...
SET status = 'disabled'
WHERE activity_code = 'gaokao_lucky_sign_2026'
  AND result_code LIKE 'sign_%'
  AND result_code NOT IN ('sign_001', 'sign_002', 'sign_003', 'sign_004', 'sign_005', 'sign_006', 'sign_007', 'sign_008', 'sign_009', 'sign_010', 'sign_011', 'sign_012', 'sign_013', 'sign_014', 'sign_015', 'sign_016', 'sign_017', 'sign_018', 'sign_019', 'sign_020');
-- End latest exam sign library override
